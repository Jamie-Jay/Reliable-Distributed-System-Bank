...
import team.group26.activeReplica.handler.PassiveBankUpHandler;
...
public class PrimaryServer {
    ...
    public void runService() {
        try {
            ...
            if (syncBackup) {
                if (backupPort1 != 0) {
                    PassiveBankUpHandler PassiveBankUpHandler1 = new PassiveBankUpHandler(backUpHost, backupPort1, interval, timeout, bank);
                    PassiveBankUpHandler1.start();
                    System.out.println("The Backup:" + backupPort1 + " for [Server " + sid + "] is running");
                }
                if (backupPort2 != 0) {
                    PassiveBankUpHandler PassiveBankUpHandler2 = new PassiveBankUpHandler(backUpHost, backupPort2, interval, timeout, bank);
                    PassiveBankUpHandler2.start();
                    System.out.println("The Backup:" + backupPort2 + " for [Server " + sid + "] is running");
                }
            }
